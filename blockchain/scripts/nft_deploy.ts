...
async function main() {
  ...
  console.log(
    `View contract on polygonscan: https://mumbai.polygonscan.com/address/${college.address}`
  );
  console.log(
    `View collection on OpenSea: https://testnets.opensea.io/assets/mumbai/${college.address}`
  );
